...
Mirror.statics.create = async function(contract, contact, callback) {
  var self = this;
  ...
  try {
    const result = await mirror.save();
...
Mirror.statics.createWithToken = async function(contract, contact, token, callback) {
  var self = this;
